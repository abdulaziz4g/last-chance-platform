...
/**
 * The interactive half of the booking page. Split out from `page.tsx` so the
 * page itself can stay a server component and read the session for the header —
 * a client component cannot, and a shared layout would also have wrapped the
 * nested `/pay` route with the wrong heading.
 */
export function BookForm() {
  ...
  return (
    <form action={formAction} className="space-y-5">
      ...
      <AvailabilityWatch unitId={unitId} checkIn={checkIn} checkOut={checkOut} />
